...
class SplitSimplePaymentRequest extends SimplePaymentRequest
{
    /**
     * @var ?int
    ...
    public function setNbrEch(?int $nbrEch): SplitSimplePaymentRequest
    {
        $this->nbrEch = $nbrEch;
    ...
    public function setDateEch1(?DateTime $dateEch1): SplitSimplePaymentRequest
    {
    ...
    public function setDateEch2(?DateTime $dateEch2): SplitSimplePaymentRequest
    {
    ...
    public function setDateEch3(?DateTime $dateEch3): SplitSimplePaymentRequest
    {
    ...
    public function setDateEch4(?DateTime $dateEch4): SplitSimplePaymentRequest
    {
    ...
    public function setMontantEch1(?float $montantEch1): SplitSimplePaymentRequest
    {
    ...
    public function setMontantEch2(?float $montantEch2): SplitSimplePaymentRequest
    {
    ...
    public function setMontantEch3(?float $montantEch3): SplitSimplePaymentRequest
    {
    ...
    public function setMontantEch4(?float $montantEch4): SplitSimplePaymentRequest
    {
